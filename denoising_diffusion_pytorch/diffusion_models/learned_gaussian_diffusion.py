...
from denoising_diffusion_pytorch.diffusion_models.denoising_diffusion_pytorch import GaussianDiffusion, extract, \
    unnormalise_to_zero_to_one
...
class LearnedGaussianDiffusion(GaussianDiffusion):
    ...
    def model_predictions(self, x, t):
        ...
        if self.objective == 'pred_noise':
            ...
            x_start = self.predict_x0_from_noise(x, t, model_output)

        elif self.objective == 'pred_x0':
            pred_noise = self.predict_noise_from_xt(x, t, model_output)
    ...
    def p_mean_variance(self, *, x, t, clip_denoised, model_output=None):
        ...
        var_interp_frac = unnormalise_to_zero_to_one(var_interp_frac_unnormalized)

        model_log_variance = var_interp_frac * max_log + (1 - var_interp_frac) * min_log
        model_variance = model_log_variance.exp()

        x_start = self.predict_x0_from_noise(x, t, pred_noise)
